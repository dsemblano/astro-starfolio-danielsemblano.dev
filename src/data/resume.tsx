...
export const DATA = {
  ...
  sections: {
    ...
    projects: {
      ...
      text: "Important projects in which I participated.",
    },
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Web development alongside user support, networking, email server management, and hardware maintenance.",
    },
    {
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Online store specializing in Brazilian wines, artisanal wineries, limited micro-lot productions, and an excellent selection.",
      technologies: [
        "roots.io",
        "WordPress",
        "WooCommerce",
